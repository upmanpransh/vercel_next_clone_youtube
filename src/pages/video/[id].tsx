    ...
    return <div className="p-4">
        ...
        <div className="grid gap-4 grid-cols-12 pt-5">
            <div className="col-span-12 md:col-span-9 sm:col-span-8">
                <video width={"100%"} height={"720px"} controls src="https://i.ytimg.com/vi/ow77NqggH-0/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLAAUpslWsH92KPj9sVlHhvIObP_1Q" />
